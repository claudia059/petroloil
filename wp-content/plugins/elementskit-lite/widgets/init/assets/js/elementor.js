    ...
    let n = {
        ...
        Image_Accordion: function(t) {
            ...
            t.on("click", ".ekit-image-accordion-item", (function(t) {
                let n = e(this),
                    ...
                    a = n.find("a, a *"),
                    l = e(t.target).is(a),
                    d = o ? .is_external ? o.is_external : "_self";
                if ("hover" === s || i === this) !l && o ? .url && ElementsKit_Helper.isValidURL(o.url) && window.open(o.url, d);
                else {
                    ...
                    if (n.hasClass("item-opened")) return void(!l && o ? .url && ElementsKit_Helper.isValidURL(o.url) && window.open(o.url, d))
                }
            }))
        },
        Nav_Menu: function(t) {
        ...
        Countdown_Timer: function(t) {
            ...
            if (l.length) {
                ...
                l.theFinalCountdown(d.ekitCountdown, (function(e) {
                    m(c.s, e.offset.seconds, o), m(c.m, e.offset.minutes, i), m(c.h, e.offset.hours, s), m(c.d, e.offset.days, a), m(c.w, e.offset.weeks, r), c.s = e.offset.seconds, c.m = e.offset.minutes, c.h = e.offset.hours, c.d = e.offset.days, c.w = e.offset.weeks
                })).on("finish.countdown", (function() {
                    this.innerHTML = ElementsKit_Helper.escapeHtml(d.finishTitle) + "<br/>" + ElementsKit_Helper.escapeHtml(d.finishContent)
                }))
            }
        },
        ...
        Video: function(t) {
            var n = (r = t.find(".video-content")).find(".ekit-video-popup"),
                ...
                a = t.data("id"),
                l = s ? .bg_color,
                d = t.closest("[data-elementor-id]").data("elementor-id");
            if (n.length > 0) {
                const c = r.find(".ekit-hidden-icons .ekit-popup-close-icon")[0] ? .outerHTML,
                    m = document.createElement("style"),
                    p = `${s?.videoClass}-${a}`;
                m.textContent = `.${p} { background-color: ${l}; }`, document.head.appendChild(m);
                const f = {
                    type: s.videoType,
                    mainClass: p,
                    removalDelay: 160,
                    ...
                    callbacks: {
                        ...
                        open: function() {
                            o.find(".mfp-close").addClass("ekit-video-popup-close"), window.dispatchEvent(new Event("resize"))
                        },
                        close: function() {
                            o.find(".mfp-close").removeClass("ekit-video-popup-close"), t.find("video").each((function() {
                                this.pause()
                            }))
                        }
                    }
                };
                "iframe" === s.videoType && (f.iframe = {
                    ...
                    videoWidth: "900px",
                    videoHeight: "507px"
                }), e(document).on("click", ".mfp-close", (function() {
                    e.magnificPopup.close()
                })), n.magnificPopup(f)
            }
            s = (r = t.find(".ekit-video-frame")).data("video-setting"), i = r.data("video-player");
            var r, c = t.find(".ekit-inline-video-content"),
                m = c.find(".ekit-video-inline-btn"),
                p = c.find(".ekit-inline-video-overlay-image");
            "inline" === s ? .videoType && "self" === s ? .videoTypeName && r.find("video.inline_video_class").mediaelementplayer({
                features: i,
                videoVolume: s ? .videoVolume,
                startVolume: s ? .startVolume,
                autoplay: !!s ? .autoplay,
                ...
                videoWidth: "100%",
                videoHeight: "100%"
            }), p.length > 0 && m.length > 0 && m.on("click", (function(n) {
                if (n.preventDefault(), "self" === s.videoTypeName && "inline" === s.videoStyle) {
                    let t = e(".ekit-video-frame video.inline_video_class");
                    t.length && (t.prop("autoplay", !0).attr("autoplay"), t[0].play())
                } else if (("youtube" === s.videoTypeName || "vimeo" === s.videoTypeName) && "inline" === s.videoStyle) {
            ...
            var f = t.find(".ekit-video-frame").find(".ekit-inline-video-content");
            if (f.length > 0) {
                var u = f.css("--video-aspect-ratio");
                u && f.css("aspect-ratio", u)
            }
        },
